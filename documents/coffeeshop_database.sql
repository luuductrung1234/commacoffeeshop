...
('FM00000010',	N'Soda', 					N'',		0,	N'khô',			N'thùng',	0,	N'Chợ Tân Mỹ, Red Dragon Fly shop'),
('FM00000011',	N'Whipping cream', 			N'',		0,	N'sữa',			N'hộp',		0,	N'Coopxtra (3nd floor)'),
('FM00000012',	N'Cream cheese', 			N'',		0,	N'sữa',			N'hộp',		0,	N'Coopxtra (3nd floor)'),
('FM00000013',	N'Milk Tea Powder', 		N'',		0,	N'khô',			N'hộp',		0,	N'Coopxtra (2nd floor)'),
('FM00000014',	N'Matcha Tea Powder', 		N'',		0,	N'khô',			N'hộp',		0,	N'Coopxtra (2nd floor)'),
('FM00000015',	N'Durian coffee Powder', 	N'',		0,	N'khô',			N'hộp',		0,	N'Lotte Mart'),
('FM00000016',	N'Peach Tea Bag(cozy)', 	N'',		0,	N'khô',			N'hộp',		0,	N'Coopxtra (2nd floor)'),
('FM00000017',	N'Strawberry Tea Bag(cozy)',N'',		0,	N'khô',			N'hộp',		0,	N'Lotte Mart'),
('FM00000018',	N'Apple Tea bag(cozy)', 	N'',		0,	N'khô',			N'hộp',		0,	N'Coopxtra (2nd floor)'),
('FM00000019',	N'Lemon Tea bag(cozy)', 	N'',		0,	N'khô',			N'hộp',		0,	N'Coopxtra (2nd floor)'),
('FM00000020',	N'Cacao Powder', 			N'',		0,	N'khô',			N'bịch',	0,	N'Ham Nghi'),
('FM00000021',	N'sugar (bar)', 			N'',		0,	N'khô',			N'kí',		0,	N'grocery'),
('FM00000022',	N'Icing sugar', 			N'',		0,	N'khô',			N'kí',		0,	N'Ham Nghi'),
('FM00000023',	N'Peach Can', 				N'',		0,	N'khô',			N'lon',		0,	N'0906677787'),
('FM00000024',	N'Mandarin orange Can', 	N'',		0,	N'khô',			N'lon',		0,	N'Ham Nghi'),
('FM00000028',	N'Mint leaf', 				N'',		0,	N'rau củ',		N'kí',		0,	N'Super market or coopxtra'),
('FM00000029',	N'Blue curacao syrup', 		N'',		0,	N'khô',			N'chai',	0,	N'0906677787'),
('FM00000030',	N'Peach syrup', 			N'',		0,	N'khô',			N'chai',	0,	N'0906677787'),
('FM00000031',	N'Ginger honey sauce', 		N'',		0,	N'khô',			N'bình',	0,	N'Skymart 0854101219 save point (0751)'),
('FM00000088',	N'Chocalate bar',			N'',		0,	N'khô',			N'kí',		0,	N'mr Vĩnh'),
('FM00000032',	N'Ketchup (bar)', 			N'',		0,	N'khô',			N'chai',	0,	N'Coopxtra (3nd floor)'),
('FM00000033',	N'Chilli sauce (bar)',		N'',		0,	N'khô',			N'chai',	0,	N'Coopxtra (3nd floor)'),
('FM00000027',	N'Lemon', 					N'',		2,	N'rau củ',		N'trái',	0,	N'Super market or coopxtra'),
('FM00000025',	N'Yellow orange', 			N'',		2,	N'rau củ',		N'trái',	0,	N'Queenland Mart'),
('FM00000026',	N'Green orange', 			N'',		2,	N'rau củ',		N'trái',	0,	N'Super market or Tien Staff or,….'),
('FM00000034',	N'ice', 					N'',		3,	N'khô',			N'bịch',	0,	N'01645422630'),
('FM00000035',	N'Plastic cup', 			N'',		3,	N'vật dụng',	N'lóc',		0,	N'Son staff : 01264463379'),
('FM00000036',	N'Plastic cover', 			N'',		3,	N'vật dụng',	N'lóc',		0,	N'Son staff : 01264463379'),
('FM00000037',	N'Paper cup', 				N'',		3,	N'vật dụng',	N'lóc',		0,	N'Son staff : 01264463379'),
('FM00000038',	N'Black cover', 			N'',		3,	N'vật dụng',	N'lóc',		0,	N'Son staff : 01264463379'),
('FM00000039',	N'Straw', 					N'',		3,	N'vật dụng',	N'lóc',		0,	N'Son staff : 01264463379'),
('FM00000040',	N'Toilet paper', 			N'',		3,	N'vật dụng',	N'cuộn',	0,	N'Coopxtra (2nd floor)'),
('FM00000041',	N'Napkin', 					N'',		3,	N'vật dụng',	N'lóc',		0,	N'Coopxtra (2nd floor)'),
('FM00000042',	N'Aroma', 					N'',		3,	N'vật dụng',	N'bình',	0,	N'Lazada'),
('FM00000043',	N'Trash bag', 				N'',		3,	N'vật dụng',	N'cuộn',	0,	N'Coopxtra (2nd floor)'),
('FM00000044',	N'Print paper', 			N'',		3,	N'vật dụng',	N'cuộn',	0,	N'maybanhang.net staff: 0912700646'),
('FM00000045',	N'Bag T', 					N'',		3,	N'vật dụng',	N'lóc',		0,	N'Lesable')									
go
